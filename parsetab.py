...
_lr_productions = [
  ...
  ('program -> class_declaration','program',1,'p_program','Examen2.py',231),
  ('program -> program class_declaration','program',2,'p_program','Examen2.py',232),
  ('class_declaration -> PUBLIC CLASS ID LBRACE class_body RBRACE','class_declaration',6,'p_class_declaration','Examen2.py',248),
  ('class_body -> statement main','class_body',2,'p_class_body','Examen2.py',256),
  ('class_body -> class_body statement','class_body',2,'p_class_body','Examen2.py',257),
  ('class_body -> main','class_body',1,'p_class_body','Examen2.py',258),
  ('class_body -> statement class_body','class_body',2,'p_class_body','Examen2.py',259),
  ('main -> PUBLIC STATIC VOID MAIN LPAREN STRING LBRACKET RBRACKET ARGS RPAREN LBRACE statements RBRACE','main',13,'p_main','Examen2.py',274),
  ('statement -> assignment','statement',1,'p_statement','Examen2.py',283),
  ('statement -> array_usage','statement',1,'p_statement','Examen2.py',284),
  ('statement -> print_statement','statement',1,'p_statement','Examen2.py',285),
  ('statement -> dcl_variable SEMI','statement',2,'p_statement','Examen2.py',286),
  ('statement -> for_statement','statement',1,'p_statement','Examen2.py',287),
  ('statement -> if_statement','statement',1,'p_statement','Examen2.py',288),
  ('expression -> ID','expression',1,'p_expression','Examen2.py',296),
  ('expression -> NUMBER','expression',1,'p_expression','Examen2.py',297),
  ('expression -> ID EQUALS propiedades','expression',3,'p_expression','Examen2.py',298),
  ('expression -> ID GT propiedades','expression',3,'p_expression','Examen2.py',299),
  ('expression -> ID GE propiedades','expression',3,'p_expression','Examen2.py',300),
  ('expression -> ID LE propiedades','expression',3,'p_expression','Examen2.py',301),
  ('expression -> ID LT propiedades','expression',3,'p_expression','Examen2.py',302),
  ('expression -> NOT expression','expression',2,'p_expression','Examen2.py',303),
  ('condicion -> ID EQUALS NUMBER','condicion',3,'p_condicion','Examen2.py',315),
  ('condicion -> ID GT NUMBER','condicion',3,'p_condicion','Examen2.py',316),
  ('condicion -> ID GE NUMBER','condicion',3,'p_condicion','Examen2.py',317),
  ('condicion -> ID LE NUMBER','condicion',3,'p_condicion','Examen2.py',318),
  ('condicion -> ID LT NUMBER','condicion',3,'p_condicion','Examen2.py',319),
  ('condicion -> ID AND NUMBER','condicion',3,'p_condicion','Examen2.py',320),
  ('condicion -> ID OR NUMBER','condicion',3,'p_condicion','Examen2.py',321),
  ('condicion -> NUMBER EQUALS NUMBER','condicion',3,'p_condicion','Examen2.py',322),
  ('condicion -> NUMBER GT NUMBER','condicion',3,'p_condicion','Examen2.py',323),
  ('condicion -> NUMBER GE NUMBER','condicion',3,'p_condicion','Examen2.py',324),
  ('condicion -> NUMBER LE NUMBER','condicion',3,'p_condicion','Examen2.py',325),
  ('condicion -> NUMBER LT NUMBER','condicion',3,'p_condicion','Examen2.py',326),
  ('condicion -> ID AND ID','condicion',3,'p_condicion','Examen2.py',327),
  ('condicion -> ID OR ID','condicion',3,'p_condicion','Examen2.py',328),
  ('condicion -> ID EQ ID','condicion',3,'p_condicion','Examen2.py',329),
  ('condicion -> ID EQ STRING_LITERAL','condicion',3,'p_condicion','Examen2.py',330),
  ('increment_or_decrement -> ID INCREMENT','increment_or_decrement',2,'p_increment_or_decrement','Examen2.py',337),
  ('increment_or_decrement -> ID DECREMENT','increment_or_decrement',2,'p_increment_or_decrement','Examen2.py',338),
  ('for_statement -> FOR LPAREN INT ID EQUALS NUMBER SEMI condicion SEMI increment_or_decrement RPAREN LBRACE statements RBRACE','for_statement',14,'p_for_statement','Examen2.py',344),
  ('for_statement -> FOR LPAREN INT ID EQUALS NUMBER SEMI expression SEMI increment_or_decrement RPAREN LBRACE statements RBRACE','for_statement',14,'p_for_statement','Examen2.py',345),
  ('for_statement -> FOR LPAREN tipo_palabra ID COLON ID RPAREN LBRACE statements RBRACE','for_statement',10,'p_for_statement','Examen2.py',346),
  ('if_statement -> IF LPAREN condicion RPAREN LBRACE statements RBRACE','if_statement',7,'p_if_statement','Examen2.py',354),
  ('if_statement -> IF LPAREN condicion RPAREN LBRACE statements RBRACE ELSE statements','if_statement',9,'p_if_statement','Examen2.py',355),
  ('if_statement -> IF LPAREN condicion RPAREN LBRACE statements RBRACE ELSE LBRACE statements RBRACE','if_statement',11,'p_if_statement','Examen2.py',356),
  ('args -> arg','args',1,'p_args','Examen2.py',365),
  ('args -> args arg','args',2,'p_args','Examen2.py',366),
  ('arg -> ID','arg',1,'p_arg','Examen2.py',378),
  ('arg -> STRING_LITERAL','arg',1,'p_arg','Examen2.py',379),
  ('arg -> NUMBER','arg',1,'p_arg','Examen2.py',380),
  ('arg -> NOT arg','arg',2,'p_arg','Examen2.py',381),
  ('arg -> ID COMMA','arg',2,'p_arg','Examen2.py',382),
  ('arg -> STRING_LITERAL COMMA','arg',2,'p_arg','Examen2.py',383),
  ('arg -> NUMBER COMMA','arg',2,'p_arg','Examen2.py',384),
  ('propiedades -> ID PUNTO ID','propiedades',3,'p_propiedades','Examen2.py',392),
  ('statements -> statement','statements',1,'p_statements','Examen2.py',401),
  ('statements -> statements statement','statements',2,'p_statements','Examen2.py',402),
  ('assignment -> ID EQUALS expression SEMI','assignment',4,'p_assignment','Examen2.py',417),
  ('dcl_variable -> tipo_number ID EQUALS NUMBER','dcl_variable',4,'p_dcl_variable','Examen2.py',434),
  ('dcl_variable -> tipo_palabra ID EQUALS STRING_LITERAL','dcl_variable',4,'p_dcl_variable','Examen2.py',435),
  ('dcl_variable -> tipo_booleano ID EQUALS valor_boolean','dcl_variable',4,'p_dcl_variable','Examen2.py',436),
  ('tipo_booleano -> BOOLEAN','tipo_booleano',1,'p_tipo_booleano','Examen2.py',447),
  ('tipo_number -> INT','tipo_number',1,'p_tipo_number','Examen2.py',454),
  ('tipo_number -> DOUBLE','tipo_number',1,'p_tipo_number','Examen2.py',455),
  ('tipo_palabra -> STRING','tipo_palabra',1,'p_tipo_palabra','Examen2.py',462),
  ('valor_boolean -> TRUE','valor_boolean',1,'p_valor_boolean','Examen2.py',469),
  ('valor_boolean -> FALSE','valor_boolean',1,'p_valor_boolean','Examen2.py',470),
  ('array_usage -> tipo_number LBRACKET RBRACKET ID EQUALS LBRACE args RBRACE SEMI','array_usage',9,'p_array_usage','Examen2.py',477),
  ('array_usage -> tipo_palabra LBRACKET RBRACKET ID EQUALS LBRACE args RBRACE SEMI','array_usage',9,'p_array_usage','Examen2.py',478),
  ('print_statement -> SYSTEM PUNTO OUT PUNTO PRINTLN LPAREN STRING_LITERAL RPAREN SEMI','print_statement',9,'p_print_statement','Examen2.py',485),
  ('print_statement -> SYSTEM PUNTO OUT PUNTO PRINTLN LPAREN ID RPAREN SEMI','print_statement',9,'p_print_statement','Examen2.py',486),
  ('print_statement -> SYSTEM PUNTO OUT PUNTO PRINTLN LPAREN ID LBRACKET ID RBRACKET RPAREN SEMI','print_statement',12,'p_print_statement','Examen2.py',487),
  ('empty -> <empty>','empty',0,'p_empty','Examen2.py',494),
]
